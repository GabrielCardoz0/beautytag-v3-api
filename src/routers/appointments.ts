...
appointmentsRouter
  ...
  .get("/earnings", validateRole([EnumRoles.parceiro]), appointmentsController.getEarningsSummary)
  .get("/client", validateRole([EnumRoles.admin, EnumRoles.parceiro]), appointmentsController.getClientByPhone)
